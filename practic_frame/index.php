<?php
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . '/practic_frame/project/config/connection.php';
	...
	spl_autoload_register(function($class) {
		...
		$path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . '/practic_frame/' . $nameSpace . DIRECTORY_SEPARATOR . $className . '.php';
	...
	$routes = require $_SERVER['DOCUMENT_ROOT'] . '/practic_frame/project/config/routes.php';
